...
class ReadinessService
{
    ...
    public function seriousDemo(User $user, string $strategyVersionId): array
    {
        ...
        $strategyStatus = $strategy !== null ? (string) $strategy->status : 'missing';
        ...
        $predicates = [
            'frozen_strategy' => ['passed' => $strategyStatus === 'frozen', 'actual' => $strategyStatus, 'required' => 'frozen'],
    ...
    public function microLive(User $user, string $demoProgramId): array
    {
        ...
        $programStatus = $program !== null ? (string) $program->status : 'missing';
        ...
        $predicates = [
            'active_demo_program' => ['passed' => $program !== null, 'actual' => $programStatus, 'required' => 'completed'],
